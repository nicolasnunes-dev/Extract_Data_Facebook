#Code to Cloud Function to import for Big Query
...
def import_bq(dataframe):
  ...
  job_config = bigquery.LoadJobConfig(
          schema=[
              bigquery.SchemaField("Data_insercao", "DATE"),
              bigquery.SchemaField("Data_Inicio", "DATE"),
              bigquery.SchemaField("Data_Parada", "DATE"),
              bigquery.SchemaField("Nome_Conta", "STRING"),
              bigquery.SchemaField("ID_Conta", "STRING"),
              bigquery.SchemaField("Nome_Campanha", "STRING"),
              bigquery.SchemaField("ID_Campanha", "STRING"),
              bigquery.SchemaField("Criado", "STRING"),
